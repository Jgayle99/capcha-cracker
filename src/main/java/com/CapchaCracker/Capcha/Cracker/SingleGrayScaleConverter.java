...
public class SingleGrayScaleConverter {

    public static void main(String... args) {

        try {

                File folder = new File( "D:\\Capcha\\todo");
